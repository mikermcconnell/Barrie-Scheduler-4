...
> **LOCKED LOGIC**: Read `docs/rules/LOCKED_LOGIC.md` first. Detailed notes remain in `.Codex/context.md`. These rules MUST NOT be changed without explicit approval.
