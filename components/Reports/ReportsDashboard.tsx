...
import { FileText, FileSpreadsheet, Users, ArrowRight } from 'lucide-react';
...
type ReportView = 'dashboard' | 'timetable' | 'gtfs' | 'driver-sheets';
        ...
        <div className="h-full overflow-auto custom-scrollbar p-6">
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500">Generate public timetables, exports, and operational documents.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {/* Driver Sheets Card - Coming Soon */}
                    <div className="relative bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm text-left flex flex-col h-full opacity-60 cursor-not-allowed">
                        <div className="absolute top-3 right-3 px-2 py-0.5 bg-gray-200 text-gray-500 text-[10px] font-bold rounded-full uppercase tracking-wide">
                            Coming Soon
                        </div>
                        ...
                        <h3 className="text-lg font-bold text-gray-500 mb-1">Driver Sheets</h3>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            Generate run cards and bid sheets for driver assignments.
                        </p>
                    </div>
                </div>
            </div>
