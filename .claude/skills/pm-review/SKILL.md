...
1. **Gather Context**
   - Read `AGENTS.md` (authoritative repository contract and development patterns)
   - Read `docs/CONTEXT_INDEX.md` (task routing, authority, and doc tiers)
   ...
   - Read `.claude/CLAUDE.md` only for Claude-specific workflow or danger-zone guidance; it remains supplemental
