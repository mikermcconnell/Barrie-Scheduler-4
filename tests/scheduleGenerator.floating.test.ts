...
describe('scheduleGenerator floating mode defaults', () => {
    ...
    it('weights all-band fallback segment averages by observations instead of bucket count', () => {
        const config: ScheduleConfig = {
            routeNumber: '99',
            cycleMode: 'Floating',
            recoveryRatio: 0,
        ...
        const buckets: TripBucketAnalysis[] = [
            {
                ...
                isOutlier: false,
                ignored: false,
                details: [{ segmentName: 'Start to End', p50: 20, p80: 25, n: 1 }]
            }
        ];

        const bands: TimeBand[] = [
            { id: 'A', label: 'Band A', min: 20, max: 20, avg: 20, color: '#ef4444', count: 1 },
            { id: 'B', label: 'Band B', min: 30, max: 30, avg: 30, color: '#f97316', count: 10 }
        ];
            ...
            North: [
                {
                    ...
                    color: '#ef4444',
                    avgTotal: 20,
                    segments: [{ segmentName: 'Start to End', avgTime: 10, totalN: 100 }],
                    timeSlots: ['06:00']
                },
                {
                    bandId: 'B',
                    color: '#f97316',
                    avgTotal: 30,
                    segments: [{ segmentName: 'Start to End', avgTime: 30, totalN: 1 }],
                    timeSlots: ['06:30', '07:00', '07:30', '08:00', '08:30', '09:00', '09:30', '10:00', '10:30', '11:00']
                }
            ]
        };
