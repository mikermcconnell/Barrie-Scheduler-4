    ...
    it('applies 15-min debiasing and builds 18-slice atlas', () => {
        const parsed: TransitAppParsedData = {
            ...
            locations: [
                ...
                { user_id: 'u1', longitude: -79.6901, latitude: 44.3801, timestamp: '2025-01-06 07:02:00 UTC' },
                { user_id: 'u1', longitude: -79.6902, latitude: 44.3802, timestamp: '2025-01-06 07:08:00 UTC' },

                // Same user, different window -> retained
                { user_id: 'u1', longitude: -79.6904, latitude: 44.3804, timestamp: '2025-01-06 07:20:00 UTC' },

                // Jul weekday midday
                { user_id: 'u2', longitude: -79.6700, latitude: 44.4100, timestamp: '2025-07-08 11:10:00 UTC' },

                // Sep saturday
                { user_id: 'u3', longitude: -79.6500, latitude: 44.3600, timestamp: '2025-09-13 14:10:00 UTC' },
            ],
            goTripLegs: [],
            plannedTripLegs: [],
            tappedTripLegs: [],
