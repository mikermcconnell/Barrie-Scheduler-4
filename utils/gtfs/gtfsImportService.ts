...
import type { MasterTrip, MasterRouteTable } from '../parsers/masterScheduleParser';
import type { Direction } from '../config/routeDirectionConfig';
import { inferDirectionFromTerminus, getRouteConfig, parseRouteInfo } from '../config/routeDirectionConfig';
import { TimeUtils } from '../timeUtils';
import { saveDraft } from '../services/draftService';
import { saveSystemDraft, generateSystemDraftName } from '../services/systemDraftService';
import type { DraftScheduleInput, SystemDraftInput, SystemDraftRoute } from '../schedule/scheduleTypes';
import {
    getBaseStopName,
