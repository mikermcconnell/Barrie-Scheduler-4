...
export function resolveFilteredScope(timeRange: 'all' | 'year-to-date' | 'yesterday' | 'past-week' | 'past-month' | 'past-three-months' | 'single-day' | 'custom'): PerformanceDataScope {
